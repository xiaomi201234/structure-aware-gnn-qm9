...
TARGETS = ["mu", "u0_atom", "homo", "lumo", "gap", "alpha", "cv"]
...
def r2_drop(df_random_results, df_scaffold_summary):
    merged = df_random_results[["Target", "RF_R2"]].merge(
        df_scaffold_summary[["Target", "RF_R2"]],
        on="Target",
        suffixes=("_random", "_scaffold"),
    )
    return (merged["RF_R2_random"] - merged["RF_R2_scaffold"]) / merged["RF_R2_random"]
